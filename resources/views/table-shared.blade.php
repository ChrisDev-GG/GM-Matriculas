...
<html lang="es" class="h-100">
  <head>
    ...
    <!-- Custom styles -->
    <link href="{{asset('css/table-shared.css')}}" rel="stylesheet">
...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <header class="mb-auto">
    <div><!-- review this -->
      <img src="{{asset('img/gm-logo.png')}}" alt="Gabriela Mistral Logo" height="50px" class="logo-gm">
      <h3 class="float-md-start mb-0 table-title-nav">Gabriela Mistral</h3>
      <nav class="nav nav-masthead justify-content-center float-md-end nav-margin-table">
        @yield('navigator')
