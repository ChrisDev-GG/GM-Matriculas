...
@section('content-table')
    ...
    <a class="btn btn-danger btn-create" href="/registros/setback"><b>Atrasar año</b></a><br><br>
        ...
        <table class="table table-bordered" id="table-gestionar">
            ...
            <tbody>          
                @foreach($alumnos as $alumno)
                    ...
                    <th>{{$alumno->paternal_surename}} {{$alumno->maternal_surename}}</th>
                    <th>{{$alumno->grade}}</th>
                    <th>{{$alumno->run}}</th>
