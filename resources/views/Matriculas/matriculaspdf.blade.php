...
<div>
    ...
    <p>
        Nombre Apoderado: {{$data['apoderado']['name'] ?? '__________________'}} <br>
        RUT:              {{$data['apoderado']['run'] ?? '__________________'}} <br>
        Domicilio:        {{$data['apoderado']['address'] ?? '__________________'}} <br>
        Fono:             {{$data['apoderado']['phone'] ?? '__________________'}} <br>
        E-Mail:           {{$data['apoderado']['email'] ?? '__________________'}}
    </p>
    ...
    <p>
        <b>I.</b> Don {{$data['apoderado']['name'] ?? '__________________'}} matricula en el Colegio Gabriela Mistral de Ovalle en calidad de alumno a su pupilo(a)
    ...
    <div>
        ...
        <p class="apoderado-name">
            {{$data['apoderado']['name'] ?? '__________________'}}
        </p>
